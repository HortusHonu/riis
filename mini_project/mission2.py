...
async def main():
    ...
    with open(filename, "w") as log_file:
        ...
        mission_items = [
            make_item(47.3976099, 8.546518, 10, -1, True),
            make_item(47.3977725, 8.5444628, 15, -1, False),
            make_item(47.3990611, 8.545965, 20, -1, True),
            make_item(47.3988042, 8.5465878, 30, -1, False, loiter=5)
        ]
